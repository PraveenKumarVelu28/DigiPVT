...
@Component({
  selector: 'app-run-summer-sem-validation',
  templateUrl: './run-summer-sem-validation.component.html',
  styleUrls: ['./run-summer-sem-validation.component.css']
})
export class RunSummerSemValidationComponent implements OnInit {
