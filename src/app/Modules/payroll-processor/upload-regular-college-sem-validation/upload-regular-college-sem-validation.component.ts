...
@Component({
  selector: 'app-upload-regular-college-sem-validation',
  templateUrl: './upload-regular-college-sem-validation.component.html',
  styleUrls: ['./upload-regular-college-sem-validation.component.css']
})
export class UploadRegularCollegeSemValidationComponent implements OnInit {
