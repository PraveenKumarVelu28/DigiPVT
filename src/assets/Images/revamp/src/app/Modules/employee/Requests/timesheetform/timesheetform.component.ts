...
export class TimesheetformComponent implements OnInit {
  ...
  constructor(public DigiofficeService: DigiofficecorehrService, public dialogRef: MatDialogRef<TimesheetformComponent>, public router: Router) { }
  projectlist: any;
  NoOfHrs: any;
  Supervisor: any;
  Task: any;
  ...
  public save() {
    ...
    for (let i = 0; i <= this.newarray.length; i++) {
      ...
      this.DigiofficeService.InsertTimeSheets_Table(eb)
        .subscribe({
          next: data => {
            debugger
            if (data == 0) {
  ...
  public sendemail() {
    ...
    var entity1 = {
      ...
      'emailbody': 'Hi  <br> Your Employee ' + this.UserName + ' has Applied TimeSheet in Digi-Office., <br> Please Login in DigiOffice to Approve. <br><br>' + '<br>  <br> Thanks <br> Team Digi-Office',
  ...
  public addd() {
    this.showPopup = 0;
    if (this.Date == undefined || this.Date == '' || this.Task == undefined || this.Task == '' || this.StartTime == undefined || this.StartTime == '' ||
  ...
  public DeleteTimesheet(Comments: any) {
    ...
    Swal.fire({
      ...
      if (result.value == true) {
        var index = this.newarray.map((x: { Comments: any; }) => {
          return x.Comments;
        }).indexOf(Comments);
