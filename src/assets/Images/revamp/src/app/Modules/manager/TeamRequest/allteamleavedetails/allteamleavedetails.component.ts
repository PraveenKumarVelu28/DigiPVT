...
@Component({
  selector: 'app-allteamleavedetails',
  templateUrl: './allteamleavedetails.component.html',
  styleUrls: ['./allteamleavedetails.component.css']
})
export class AllteamleavedetailsComponent implements OnInit {
