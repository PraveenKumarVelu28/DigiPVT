...
export class AppComponent {
  ...
  showPopup: number = 0;
  messageId: number = 0;
  @ViewChild(SidebarWithIconComponent, { static: false }) SidebarWithIconComponent: SidebarWithIconComponent | undefined;
  constructor(public router: Router, public DigiofficeService: DigiofficecorehrService, public CookieService: CookieService) {
  ...
  getless(sidenav: any) {
    if (sidenav == true) {
      ...
      (document.getElementById("mySidebar") as HTMLInputElement).style.width = "242px";
      this.sidenav = true;
    }
