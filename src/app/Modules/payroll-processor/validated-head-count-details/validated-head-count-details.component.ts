...
@Component({
  selector: 'app-validated-head-count-details',
  templateUrl: './validated-head-count-details.component.html',
  styleUrls: ['./validated-head-count-details.component.css']
})
export class ValidatedHeadCountDetailsComponent implements OnInit {
  ...
  public GetValidatedHeadCount() {
    debugger
    this.DigiofficeService.GetValidatedHeadCount()
      .subscribe({
        next: data => {
          debugger
