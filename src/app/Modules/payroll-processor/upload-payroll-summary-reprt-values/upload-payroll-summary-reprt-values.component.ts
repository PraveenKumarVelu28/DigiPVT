...
@Component({
  selector: 'app-upload-payroll-summary-reprt-values',
  templateUrl: './upload-payroll-summary-reprt-values.component.html',
  styleUrls: ['./upload-payroll-summary-reprt-values.component.css']
})
export class UploadPayrollSummaryReprtValuesComponent implements OnInit {
  ...
  public Upload_file() {
    ...
    if (this.exceldata == undefined) {
      ...
      //   }
        ...
        this.DigiPVTService.UploadPayrollSummaryValidationForUnc(obj)
          .subscribe({
            next: data => {
              debugger
