...
@Component({
  selector: 'app-validated-tax-values',
  templateUrl: './validated-tax-values.component.html',
  styleUrls: ['./validated-tax-values.component.css']
})
export class ValidatedTaxValuesComponent implements OnInit {

  constructor(public DigiofficeService: DigiPVTService, public router: Router) { }

  ngOnInit(): void {

    this.GetPreliminarySalary();
  }
