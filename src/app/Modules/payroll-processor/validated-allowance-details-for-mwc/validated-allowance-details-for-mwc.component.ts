...
@Component({
  selector: 'app-validated-allowance-details-for-mwc',
  templateUrl: './validated-allowance-details-for-mwc.component.html',
  styleUrls: ['./validated-allowance-details-for-mwc.component.css']
})
export class ValidatedAllowanceDetailsForMWCComponent implements OnInit {
