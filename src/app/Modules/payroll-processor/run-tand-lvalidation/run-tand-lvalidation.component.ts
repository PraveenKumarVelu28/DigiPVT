...
@Component({
  selector: 'app-run-tand-lvalidation',
  templateUrl: './run-tand-lvalidation.component.html',
  styleUrls: ['./run-tand-lvalidation.component.css']
})
export class RunTandLValidationComponent implements OnInit {
...
// if( this.cutofflist.length!=0){
  ...
  this.startdate = formatDate(myDate, format, locale);
                  ...
                  debugger;
                    ...
                    this.LOPDays = 0;
                    this.DigiofficeService.GetRunUploadedPayrollElementsForPayperiodValidation(this.ID1[i],  this.startdate, this.enddate).subscribe(
                      res => {
                        debugger;
