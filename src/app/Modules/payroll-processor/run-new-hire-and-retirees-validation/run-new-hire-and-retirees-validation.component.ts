...
@Component({
  selector: 'app-run-new-hire-and-retirees-validation',
  templateUrl: './run-new-hire-and-retirees-validation.component.html',
  styleUrls: ['./run-new-hire-and-retirees-validation.component.css']
})
export class RunNewHireAndRetireesValidationComponent implements OnInit {
  viewMode = 'tab1';
                    ...
                    for (let i = 0; i < this.ID.length; i++) {
                      ...
                      this.EmployeeID = this.ID[i];
                          ...
                          debugger;
                            ...
                            this.LOPDays = 0;
                            this.DigiofficeService.GetRunMasterFileValidation(this.ID[i],  this.startdate, this.enddate).subscribe(
                              res => {
                                debugger;
                                this.StaffSalaryReports = res;
                                Swal.fire(
