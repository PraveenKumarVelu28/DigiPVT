...
@Component({
  selector: 'app-run-payroll-summary-validation',
  templateUrl: './run-payroll-summary-validation.component.html',
  styleUrls: ['./run-payroll-summary-validation.component.css']
})
export class RunPayrollSummaryValidationComponent implements OnInit {
                    ...
                    for (let i = 0; i < this.ID.length; i++) {
                      ...
                      this.EmployeeID = this.ID[i];
                          ...
                          debugger;
                            ...
                            this.LOPDays = 0;
                            this.DigiofficeService.GetRunPayrollSummaryReportValidation(this.ID[i],  this.startdate, this.enddate).subscribe(
                              res => {
                                debugger;
                                this.StaffSalaryReports = res;
                                Swal.fire(
