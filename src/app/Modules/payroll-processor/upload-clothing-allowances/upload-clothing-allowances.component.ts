...
@Component({
  selector: 'app-upload-clothing-allowances',
  templateUrl: './upload-clothing-allowances.component.html',
  styleUrls: ['./upload-clothing-allowances.component.css']
})
export class UploadClothingAllowancesComponent implements OnInit {
    ...
    if (this.exceldata == undefined) {
      ...
      for (this.i = 0; this.i < this.exceldata.length; this.i++) {
          ...
          var eb = { 
            ...
            'ProbationEndDate' : new Date(Date.UTC(0, 0, this.exceldata[this.i].ProbationEndDate - 1)),
            'ClothingAllowance' : this.exceldata[this.i].ClothingAllowance,
            'ClothingAllowanceAdjustment' : this.exceldata[this.i].ClothingAllowanceAdjustment,
            'OldClothingAllowance' : this.exceldata[this.i].OldClothingAllowance

          }
          this.DigiPVTService.InsertClothingAllowances(eb).subscribe({
            next: data => {
            debugger
            this.StaffID=data;
