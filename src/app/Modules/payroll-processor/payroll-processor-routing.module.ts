...
const routes: Routes = [
  ...
  { path: 'UploadOvertimeReport', component: UploadOvertimeReportComponent },

  { path: 'ValidatedPayrollInputs', component: ValidatedPayrollInputsComponent },

  { path: 'RunPayrollInputValidation', component: RunPayrollInputValidationComponent },
