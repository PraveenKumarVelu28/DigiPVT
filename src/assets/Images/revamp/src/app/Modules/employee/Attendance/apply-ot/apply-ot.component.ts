...
export class ApplyOtComponent implements OnInit {
  ...
  constructor(public DigiofficeService: DigiofficecorehrService, public dialogRef: MatDialogRef<ApplyOtComponent>, public router: Router, public Datepipe: DatePipe) { }
