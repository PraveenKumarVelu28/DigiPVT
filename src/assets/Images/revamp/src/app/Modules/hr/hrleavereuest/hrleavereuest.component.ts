...
@Component({
  selector: 'app-hrleavereuest',
  templateUrl: './hrleavereuest.component.html',
  styleUrls: ['./hrleavereuest.component.css']
})

export class HrleavereuestComponent implements OnInit {
