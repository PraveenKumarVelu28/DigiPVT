...
@Component({
  selector: 'app-validated-cola-values',
  templateUrl: './validated-cola-values.component.html',
  styleUrls: ['./validated-cola-values.component.css']
})
export class ValidatedColaValuesComponent implements OnInit {

  constructor(public DigiofficeService: DigiPVTService, public router: Router) { }

  ngOnInit(): void {

    this.GetValidatedColaDetails();
  }
  ...
  public GetValidatedColaDetails() {
    debugger
    this.DigiofficeService.GetValidatedColaDetails()
      .subscribe({
        next: data => {
          debugger
