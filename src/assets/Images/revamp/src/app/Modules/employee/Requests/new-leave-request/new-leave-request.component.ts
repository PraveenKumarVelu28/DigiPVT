...
export class NewLeaveRequestComponent implements OnInit {
  ...
  constructor(public DigiofficeService: DigiofficecorehrService, public dialogRef: MatDialogRef<NewLeaveRequestComponent>, public router: Router) { }
  LeaveType: any;
  CoveringStaff: any;
      ...
      .subscribe({
        next: data => {
          ...
          if (data != 0) {
            ...
            this.showPopup = 1;
            this.messageId = 8;
            location.href = "#/Employee/LeaveListDashboard";
            location.reload();
            this.loader = false;
          }
        }, error: (err) => {
