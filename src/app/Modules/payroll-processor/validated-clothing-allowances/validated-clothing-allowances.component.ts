...
@Component({
  selector: 'app-validated-clothing-allowances',
  templateUrl: './validated-clothing-allowances.component.html',
  styleUrls: ['./validated-clothing-allowances.component.css']
})
export class ValidatedClothingAllowancesComponent implements OnInit {

  constructor(public DigiofficeService: DigiPVTService, public router: Router) { }

  ngOnInit(): void {

    this.GetValidatedClothingAllowances();
  }
  ...
  public GetValidatedClothingAllowances() {
    debugger
    this.DigiofficeService.GetValidatedClothingAllowances()
      .subscribe({
        next: data => {
          debugger
