...
@Component({
  selector: 'app-upload-retro-values-ot',
  templateUrl: './upload-retro-values-ot.component.html',
  styleUrls: ['./upload-retro-values-ot.component.css']
})
export class UploadRetroValuesOTComponent implements OnInit {
  ...
  delete(ID : any){
    ...
    Swal.fire({
      ...
      if (result.value == true) {
        this.DigiPVTService.DeleteOTRetroAdjustment(ID)
          .subscribe({
            next: data => {
              debugger
