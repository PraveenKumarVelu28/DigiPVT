...
@Component({
  selector: 'app-validated-payroll-inputs',
  templateUrl: './validated-payroll-inputs.component.html',
  styleUrls: ['./validated-payroll-inputs.component.css']
})
export class ValidatedPayrollInputsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.GetValidatedPayrollInputs();
  }
  ...
  public GetValidatedPayrollInputs() {
    debugger
    this.DigiofficeService.GetValidatedPayrollInputs()
      .subscribe({
        next: data => {
          debugger
