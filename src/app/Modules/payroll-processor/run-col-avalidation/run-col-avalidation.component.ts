...
@Component({
  selector: 'app-run-col-avalidation',
  templateUrl: './run-col-avalidation.component.html',
  styleUrls: ['./run-col-avalidation.component.css']
})
export class RunColAValidationComponent implements OnInit {
