...
@Component({
  selector: 'app-run-basic-pay-validation',
  templateUrl: './run-basic-pay-validation.component.html',
  styleUrls: ['./run-basic-pay-validation.component.css']
})
export class RunBasicPayValidationComponent implements OnInit {
...
// if( this.cutofflist.length!=0){
  ...
  this.startdate = formatDate(myDate, format, locale);
                  ...
                  debugger;
                    ...
                    this.LOPDays = 0;
                    this.DigiofficeService.GetRunBasicPayValidation(this.ID1[i],  this.startdate, this.enddate).subscribe(
                      res => {
                        debugger;
                    ...
                    for (let i = 0; i < this.ID.length; i++) {
                      ...
                      this.EmployeeID = this.ID[i];
                          ...
                          debugger;
                            ...
                            this.LOPDays = 0;
                            this.DigiofficeService.GetRunBasicPayValidation(this.ID[i],  this.startdate, this.enddate).subscribe(
                              res => {
                                debugger;
                                this.StaffSalaryReports = res;
                                Swal.fire(
