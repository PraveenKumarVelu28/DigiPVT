...
@Component({
  selector: 'app-run-loan-proceeds-validation',
  templateUrl: './run-loan-proceeds-validation.component.html',
  styleUrls: ['./run-loan-proceeds-validation.component.css']
})
export class RunLoanProceedsValidationComponent implements OnInit {
                    ...
                    for (let i = 0; i < this.ID.length; i++) {
                      ...
                      this.EmployeeID = this.ID[i];
                          ...
                          debugger;
                            ...
                            this.LOPDays = 0;
                            this.DigiofficeService.GetRunLoanProceedsValidation(this.ID[i],  this.startdate, this.enddate).subscribe(
                              res => {
                                debugger;
                                this.StaffSalaryReports = res;
                                Swal.fire(
