...
@Component({
  selector: 'app-upload-tand-lvalues',
  templateUrl: './upload-tand-lvalues.component.html',
  styleUrls: ['./upload-tand-lvalues.component.css']
})
export class UploadTandLValuesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.GetUploadedPayrollElementsForPayperiod();
  ...
  public Upload_file() {
    ...
    if (this.exceldata == undefined) {
      ...
      //   }
        ...
        this.DigiPVTService.InsertUploadedPayrollElementsForPayperiod(obj)
          .subscribe({
            next: data => {
              debugger
