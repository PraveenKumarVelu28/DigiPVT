...
@Component({
  selector: 'app-run-clothing-allowance',
  templateUrl: './run-clothing-allowance.component.html',
  styleUrls: ['./run-clothing-allowance.component.css']
})
export class RunClothingAllowanceComponent implements OnInit {
...
// if( this.cutofflist.length!=0){
  ...
  this.startdate = formatDate(myDate, format, locale);
                  ...
                  debugger;
                    ...
                    this.LOPDays = 0;
                    this.DigiofficeService.GetRunCOLAValidation(this.ID1[i],  this.startdate, this.enddate).subscribe(
                      res => {
                        debugger;
