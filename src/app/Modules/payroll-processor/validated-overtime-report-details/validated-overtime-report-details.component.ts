...
@Component({
  selector: 'app-validated-overtime-report-details',
  templateUrl: './validated-overtime-report-details.component.html',
  styleUrls: ['./validated-overtime-report-details.component.css']
})
export class ValidatedOvertimeReportDetailsComponent implements OnInit {
